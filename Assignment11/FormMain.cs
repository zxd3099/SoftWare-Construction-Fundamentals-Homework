...
namespace Assignment10
{
  public partial class FormMain : Form {
    ...
    private void InitOrders() {
      ...
      order.AddItem(new OrderDetail("1", 1, new Goods("1", "apple", 100.0), 10));
      order.AddItem(new OrderDetail("2", 2, new Goods("2", "egg", 50.0), 61));
      orderService.AddOrder(order);
      Order order2 = new Order(2, new Customer("2", "zhang"), new List<OrderDetail>());
      order2.AddItem(new OrderDetail("3", 1, new Goods("2", "egg", 200.0), 10));
