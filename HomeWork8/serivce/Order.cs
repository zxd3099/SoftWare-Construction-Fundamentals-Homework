...
namespace Service
{
    public class Order : IComparable<Order>
    {
        ...
        public Order(string orderID, Client orderClient, List<OrderDetail> detail)
        {
        ...
        public override bool Equals(object obj)
        {
            return obj is Order order &&
                   ...
                   EqualityComparer<List<OrderDetail>>.Default.Equals(Detail, order.Detail) &&
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<List<OrderDetail>>.Default.GetHashCode(Detail);
